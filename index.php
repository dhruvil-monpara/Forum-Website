    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" style="width: 100% ; height: 500px;">
            <div class="carousel-item active">
                <img alt="crypto" style="width: 100% ; height: 700px;" src="upload/6547.jpg"
                    class="d-block w-100">
            </div>
                ...
                echo '<div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                                ...
                                <div class="card-body d-flex flex-column">
                                   ...
                                   <p class="card-text">'. htmlspecialchars($short_description).'</p>
                                    <a   class="btn btn-outline-success mt-auto" href="Partials/threadlist.php?catid='.$Category_id.'/">Go Thread</a>
                                </div>
                                </div>
                            </div>';
